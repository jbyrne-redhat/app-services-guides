[role="_abstract"]
Reuse test. The application in this quick start uses a Kafka topic called `{topic-name}` to produce and consume messages. In this task, you'll create the `{topic-name}` topic in your Kafka instance.
